import { a as getDatabaseUsername, n as getAuthMethodDescription, o as getDatabricksToken } from "./src-pe6ovBD5.mjs";
...
const project = createTable("Project", {
	...
	color: text("color"),
	icon: text("icon"),
	isActive: varchar("isActive", { enum: ["true", "false"] }).notNull().default("true"),
...
const fileUpload = createTable("FileUpload", {
	id: uuid("id").primaryKey().notNull().defaultRandom(),
	...
	metadata: jsonb("metadata").$type(),
	createdAt: timestamp("createdAt").notNull().defaultNow(),
	volumePath: text("volumePath"),
	volumeCatalog: text("volumeCatalog"),
	volumeSchema: text("volumeSchema"),
	volumeName: text("volumeName"),
	storageType: varchar("storageType", { enum: ["volume", "memory"] }).notNull().default("memory"),
	fileChecksum: text("fileChecksum")
});
const chatContext = createTable("ChatContext", {
	id: uuid("id").primaryKey().notNull().defaultRandom(),
	...
	contextType: varchar("contextType", { enum: [
		"file",
		"memory",
		"instruction"
	] }).notNull(),
...
const projectFile = createTable("ProjectFile", {
	id: uuid("id").primaryKey().notNull().defaultRandom(),
	projectId: uuid("projectId").notNull().references(() => project.id, { onDelete: "cascade" }),
	fileId: uuid("fileId").notNull().references(() => fileUpload.id, { onDelete: "cascade" }),
	addedAt: timestamp("addedAt").notNull().defaultNow(),
	addedBy: text("addedBy").notNull()
});
const projectContext = createTable("ProjectContext", {
	id: uuid("id").primaryKey().notNull().defaultRandom(),
	projectId: uuid("projectId").notNull().references(() => project.id, { onDelete: "cascade" }),
	contextType: varchar("contextType", { enum: [
		"instruction",
...
async function getConnection() {
	const { default: postgres } = await import("./src-s8WiN8aN.mjs");
...
//#endregion
export { lt as _, fileUpload as a, projectContext as c, desc as d, and as f, inArray as g, gte as h, chat as i, projectFile as l, gt as m, isDatabaseAvailable as n, message as o, eq as p, drizzle as r, project as s, getDb as t, asc as u, sql as v };